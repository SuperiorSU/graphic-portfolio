...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="lg:h-[360vh] md:h-[360vh] h-[320vh] py-24  overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
